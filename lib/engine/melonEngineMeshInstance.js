MelonEngine.MeshInstance = class{ 
    ...
    constructor(scene, mesh, programInstance, renderer, options = {} ) {
        ...
        this.rendererIndex = renderer.registerMeshInstance(this.unique? this : null, mesh, this.program, this.transform.getGlobalTransform(), programInstance.uniformBufferBindings);
