 ...
 */
function formatInfoLog(infoLog) {
    if (infoLog === null) {
 ...
 */
export function compileShader(gl, shaderType, shaderSrc) {
    ...
    switch (shaderType) {
        ...
        case gl.FRAGMENT_SHADER:
            ...
            break;
        default:
            throw new Error("Invalid `shaderType`!\n" +
 ...
 * @returns The compiled shader object.
 */
export async function compileShaderFromURL(gl, shaderType, shaderURL) {
 ...
 * @returns The compiled shader object.
 */
export function compileShaderFromScriptTag(gl, scriptElem) {
    // Get script tag
    ...
    switch (scriptElem.type) {
        ...
        case 'x-shader/x-fragment':
            ...
            break;
        default:
            throw new Error("Shader's script tag has unknown type!\n" +
 ...
 */
export function initShaders(gl, vertShader, fragShader) {
